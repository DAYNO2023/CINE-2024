...
{
    public class ValidarSessionFacturas_emcabezados : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (!(controller == "Home" && action == "Login"))
            {
                ...
                if (pantalla != null && pantalla.Contains("Factura_Encabezado") || admin != null && admin.Contains("si"))
                {
